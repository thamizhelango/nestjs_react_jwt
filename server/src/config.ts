...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8080';
  'jhipster.clientApp.name' = 'nestjsreact';
  ...
  'jhipster.mail.from' = 'nestjsreact@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'nestjsreact API';
  'jhipster.swagger.description' = 'nestjsreact API documentation';
  ...
  'eureka.instance.appname' = 'nestjsreact';
  'eureka.instance.instanceId' = 'nestjsreact:${random.value}';
