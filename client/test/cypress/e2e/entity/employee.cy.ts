...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="firstName"]`).type('Lolita');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Lolita');

      cy.get(`[data-cy="lastName"]`).type("O'Keefe");
      cy.get(`[data-cy="lastName"]`).should('have.value', "O'Keefe");

      cy.get(`[data-cy="email"]`).type('Ines40@yahoo.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Ines40@yahoo.com');

      cy.get(`[data-cy="phoneNumber"]`).type('nor calm as');
      cy.get(`[data-cy="phoneNumber"]`).should('have.value', 'nor calm as');

      cy.get(`[data-cy="hireDate"]`).type('2024-08-21T07:46');
      cy.get(`[data-cy="hireDate"]`).blur();
      cy.get(`[data-cy="hireDate"]`).should('have.value', '2024-08-21T07:46');

      cy.get(`[data-cy="salary"]`).type('27505');
      cy.get(`[data-cy="salary"]`).should('have.value', '27505');

      cy.get(`[data-cy="commissionPct"]`).type('2628');
      cy.get(`[data-cy="commissionPct"]`).should('have.value', '2628');
