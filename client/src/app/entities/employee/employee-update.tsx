  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="nestjsreactApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="nestjsreactApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('nestjsreactApp.employee.firstName')}
              ...
              <ValidatedField
                label={translate('nestjsreactApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('nestjsreactApp.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              />
              <ValidatedField
                label={translate('nestjsreactApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('nestjsreactApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('nestjsreactApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('nestjsreactApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('nestjsreactApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('nestjsreactApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
