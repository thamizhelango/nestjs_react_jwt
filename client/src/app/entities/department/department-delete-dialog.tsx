...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="nestjsreactApp.department.delete.question">
        <Translate contentKey="nestjsreactApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
