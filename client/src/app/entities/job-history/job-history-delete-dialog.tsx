...
export const JobHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="nestjsreactApp.jobHistory.delete.question">
        <Translate contentKey="nestjsreactApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
